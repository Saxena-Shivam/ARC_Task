    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-700 via-purple-700 to-pink-500 flex flex-col">
      ...
      <header className="flex justify-between items-center px-6 py-5 lg:px-12">
        ...
        <div className="sm:hidden relative">
          ...
          {/* Dropdown Menu */}
          {menuOpen && (
            <div className="absolute right-0 mt-2 w-40 bg-white rounded-xl shadow-lg flex flex-col z-50">
              <Link
                to="/login"
                className="px-5 py-3 text-blue-700 font-semibold hover:bg-blue-50 rounded-t-xl transition text-center"
              ...
              <Link
                to="/signup"
                className="px-5 py-3 text-yellow-900 font-semibold hover:bg-yellow-100 rounded-b-xl transition text-center"
                onClick={() => setMenuOpen(false)}
              >
                Get Started
              </Link>
